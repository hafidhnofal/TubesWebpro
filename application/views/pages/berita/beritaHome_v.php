...
<?php endif; ?>
    ...
    <div class="row mt-5">
        <div class="col">
            ...
            <table class="table mt-1" style="table-layout: fixed">
                <thead>
                    <tr>
                ...
                <tbody>
                    <tr><?php foreach ($berita as $brt) : ?>
                        <td class="text-center" style="word-wrap:break-word"><?= $brt['judul']; ?></td>
                        <td class="text-center" style="word-wrap:break-word"><?= $brt['ringkasan']; ?></td>
                        <td class="text-center" style="word-wrap:break-word"><?= $brt['kategori']; ?></td>
                        <td class="text-center" style="word-wrap:break-word"><?= $brt['tgl_buat']; ?></td>
                        <td class="text-center" style="word-wrap:break-word">
                            <img src=" <?php echo base_url();?>asset/images/berita/<?= $brt['image']; ?>" width="64" />
                       </td>
                        <td class="text-center">

                        <a href="<?php echo base_url(); ?>berita/beritaLihat/<?= $brt['id_berita'] ?>" class="badge badge-info float-center" style="padding:9px; margin-bottom:5px">Lihat...</a>
